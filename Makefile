...
ifeq ($(MULTIARCH),true)
	...
	BUILDBIN=true
	TARGETARCHS=amd64 arm64
	DOCKERBUILD=$(DOCKERCMD) buildx build --no-cache --pull --push $(foreach arch,${TARGETARCHS},--platform=linux/${arch}) $(foreach label,${IMAGELABELS},--label=${label})
endif
